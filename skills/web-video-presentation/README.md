...
It also includes theme tokens, React/TypeScript, exact-time frame review, timeline/SRT generation, and the verified voiceover importer. A coding agent designs the actual scenes. This produces web presentations, not a `.pptx` file. After review, the preview page can export 1K / 2K / 4K MP4 from the top-right **导出** button. Screen recording remains a fallback.
